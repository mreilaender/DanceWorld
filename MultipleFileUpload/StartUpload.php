...
function makeDirs() {
	...
	$GLOBALS['target_dir'] = $tmp3 . "Bilder/Fotos/"; // Picture directory
	$GLOBALS['thum_dir'] = $tmp3 . "Bilder/Thumbnails/"; // Thumbnail directory
	$GLOBALS['temp_dir'] = $tmp3 . "Bilder/Temporaer/"; // Temporary directory, where files will be uploaded in full size (e.g. 4k), but will be cleared after finishing convertation
	return true;
}
